// src/lib/uwuify-core.ts
// This is an intermediary module to break circular dependencies
...
/**
 * Core implementation of uwuifying text using the Rust binary
 * 
 * @param text - The text to uwuify
 * @returns The uwuified text
 * @throws Error if the Rust uwuification fails
 */
export async function uwuifyTextCore(text: string): Promise<string> {
  try {
